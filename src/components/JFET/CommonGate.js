...
import common_gate from "../../images/JFET/common_gate.png";

function CommonGate({ show, handleClose, title }) {
  const initialState1 = {
    vgs: 0,
    id: 0,
    gmo: 0,
  ...
  return (
    <Modal show={show} onHide={clearState} scrollable={true} size="lg">
      ...
      <Modal.Body>
        <img src={common_gate} className="img-fluid shadow-4" alt="..." />
