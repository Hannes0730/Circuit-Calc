...
import common_source from "../../images/JFET/common_source.png";

//(FIX CODE)

function VoltageDividerFet({ show, handleClose, title }) {
  const initialState1 = {
    vg: 0,
    vgs: 0,
    id: 0,
  ...
  return (
    <Modal show={show} onHide={clearState} scrollable={true} size="lg">
      ...
      <Modal.Body>
        <img src={common_source} className="img-fluid shadow-4" alt="..." />
...
export default VoltageDividerFet;
