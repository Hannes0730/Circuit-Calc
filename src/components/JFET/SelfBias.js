...
import self_bias_fet from "../../images/JFET/self_bias_fet.png";

function SelfBias({ show, handleClose, title }) {
  const initialState1 = {
    vgs: 0,
    idq: 0,
    vds: 0,
    ...
    <Modal show={show} onHide={clearState} scrollable={true} size="lg">
      ...
      <Modal.Body>
        <div className="text-center">
          <img src={self_bias_fet} className="img-fluid shadow-4" alt="..." />
        </div>
