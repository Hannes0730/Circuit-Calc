...
import fixed_biased from "../../images/BJT/fixed_bias.png";

function FixedBias({ show, handleClose, title }) {
  const initialState = {
    Ib: 0,
    Ic: 0,
    Ie: 0,
  ...
  return (
    <Modal show={show} onHide={clearState} scrollable={true} size="lg">
      ...
      <Modal.Body>
        <img src={fixed_biased} className="img-fluid shadow-4" alt="..." />
      ...
      <Modal.Footer>
        <Button type="submit" variant="primary" onClick={fixedBiased}>
          Calculate
        </Button>
      </Modal.Footer>
    </Modal>
